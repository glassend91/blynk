...
export const updateAutoPaySettings = async (
  data: UpdateAutoPaySettingsRequest,
): Promise<{ message: string; settings: AutoPaySettings }> => {
  try {
    const response = await apiClient.put(
      "/payment-methods/auto-pay/settings",
      data,
    );
    return response.data;
  } catch (error) {
...
export const createCustomerSetupIntent = async (
  customerId: string,
): Promise<SetupIntentResponse> => {
  try {
    const response = await apiClient.post(
      `/v1/customer/${customerId}/payment-methods/setup-intent`,
    );
    return response.data;
  } catch (error) {
...
export const setCustomerDefaultPaymentMethod = async (
  ...
  try {
    const response = await apiClient.put(
      `/v1/customer/${customerId}/payment-methods/${paymentMethodId}/default`,
    );
    return response.data;
  } catch (error) {
...
export const deleteCustomerPaymentMethod = async (
  ...
  try {
    const response = await apiClient.delete(
      `/v1/customer/${customerId}/payment-methods/${paymentMethodId}`,
    );
    return response.data;
  } catch (error) {
