...
const items = [
  ...
  {
    href: "/dashboard/service-diagnostics",
  ...
  switch (name) {
    ...
    case "person":
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          ...
          />
          <path
            d="M4 21c1.8-4 6.2-5 8-5s6.2 1 8 5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
    ...
    case "wifi":
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          <path
            d="M2 8.5C6.5 4.5 17.5 4.5 22 8.5M5 12c4-3 10-3 14 0M8.5 15.5c2-1.5 5-1.5 7 0M12 19.5h0"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
    ...
    case "chat":
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          <path
            d="M3 8.5c0-3 2-5 6-5h6c4 0 6 2 6 5v5c0 3-2 5-6 5h-.8a1 1 0 0 0-.8.4l-1.9 2.5c-.6.8-1.3.8-1.9 0l-2-2.5a1 1 0 0 0-.8-.4H9c-4 0-6-2-6-5v-5Z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
        </svg>
    ...
    case "chart":
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          <path
            d="M4 20V6M10 20V10M16 20v-8M22 20V4"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
    ...
    default:
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          <path
            d="M12 2 2 12l10 10 10-10L12 2Z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
        </svg>
    ...
    <aside className="w-[230px] shrink-0 border-r border-[#EEEAF4] bg-white">
      ...
      <div className="mt-auto px-6 py-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-[10px] bg-[#FFF1F1] px-3 py-2.5 text-[14px] font-semibold text-[#C63D3D]"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path
