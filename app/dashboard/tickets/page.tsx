          ...
          <div className="flex items-center gap-3">
            <span className="grid h-9 w-9 place-items-center rounded-full bg-[#3F205F] text-white">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <path
                  d="M2 8.5C6.5 4.5 17.5 4.5 22 8.5M5 12c4-3 10-3 14 0"
                  stroke="white"
                  strokeWidth="1.6"
                  strokeLinecap="round"
                />
            ...
            <div>
              ...
              <div className="text-[12px] text-[#6F6C90]">
                Ticket #{ticket.id.slice(-12).toUpperCase()}
              </div>
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <label className="mb-1 block text-[14px] font-semibold text-[#0A0A0A]">
              Subject
            </label>
            <input
              type="text"
              ...
              className={`w-full rounded-[8px] border px-3 py-2 text-[14px] focus:outline-none ${
