              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {service.planName && (
                      <p className="text-[14px] text-[#6F6C90] mb-1">
                        {service.planName}
                      </p>
                    )}
          ...
          <div className="space-y-4">
            <div className="rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3">
              <p className="text-[14px] font-semibold text-amber-800 mb-2">
                ACTION REQUIRED: Log in to Wholesaler Portal to manually cancel
                this service.
              </p>
            ...
            <div className="text-[14px] text-[#6F6C90]">
              <p className="mb-2">
                The service status has been updated to "Cancelled" in the CMS.
              </p>
              <p>
                You must now complete the cancellation process in the Wholesaler
                Portal.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-4">
          <div className="rounded-[10px] border border-[#DFDBE3] bg-[#F8F8F8] p-4">
            <div className="text-[14px] font-semibold text-[#0A0A0A] mb-1">
              Service Details
            </div>
            <div className="text-[14px] text-[#6F6C90]">
          ...
          <div className="rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3">
            <p className="text-[13px] text-amber-800">
              ...
              be undone. The service will be cancelled immediately.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 rounded-[10px] border border-[#DFDBE3] bg-white">
            ...
            >
              <span className="font-semibold text-red-600">*</span> Customer's
              Identity Verified
            </label>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          <div className="rounded-[10px] border border-[#DFDBE3] bg-[#F8F8F8] p-4">
            <div className="text-[14px] font-semibold text-[#0A0A0A] mb-2">
            ...
            <div className="space-y-2 text-[14px] text-[#6F6C90]">
              ...
              <p>
                <span className="font-medium text-[#0A0A0A]">Type:</span>{" "}
                {service.serviceType}
              </p>
              {service.planName && (
                <p>
                  <span className="font-medium text-[#0A0A0A]">Plan Name:</span>{" "}
                  {service.planName}
                </p>
              )}
              {service.price && (
                <p>
                  <span className="font-medium text-[#0A0A0A]">Price:</span> $
                  {service.price}
                </p>
              )}
          ...
          <div className="rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3">
            ...
            <p className="text-[13px] text-amber-700">
              Please log in to the Wholesaler Portal to upgrade/downgrade this
              service manually.
            </p>
          </div>
        </div>
