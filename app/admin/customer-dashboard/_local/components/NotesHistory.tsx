                    ...
                    <div className="space-y-3 max-h-[500px] overflow-y-auto">
                        {notes.length === 0 ? (
                            ...
                            notes.map((note) => (
                                <div
                                    key={note.id}
                                    className={`rounded-[10px] border-2 p-4 ${note.isCritical
        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between p-4 sm:p-5 md:p-6 border-b border-[#DFDBE3] flex-shrink-0 bg-white rounded-t-[16px] relative z-10">
                    <h2 className="text-[20px] sm:text-[22px] md:text-[24px] font-extrabold text-[#0A0A0A]">Add New Note</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="overflow-y-auto flex-1 p-4 sm:p-5 md:p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            />
                            <label htmlFor="criticalNote" className="text-[13px] sm:text-[14px] text-[#0A0A0A] cursor-pointer leading-relaxed">
