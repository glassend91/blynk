                    ...
                    <div className="overflow-x-auto rounded-[8px] border border-[#DFDBE3]">
                        <table className="w-full text-left text-[14px]">
                            <thead className="border-b border-[#DFDBE3] bg-[#F9FAFB] text-[#6F6C90]">
                                <tr>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Wholesale ID</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Base Plan Name</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Speed</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Custom Name</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Status</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Default Benefits</th>
                                    <th className="whitespace-nowrap px-4 py-3 font-semibold">Retail Price</th>
                                ...
                                {filteredPlans.map((plan: any) => (
                                    <tr key={plan._id} className="hover:bg-[#F9FAFB]">
                                        ...
                                        <td className="px-4 py-4">
                                            <div className="text-[#0A0A0A] font-medium">{plan.label}</div>
                                            <div className="text-[12px] text-[#6F6C90]">{plan.connection_type_name}</div>
                                        </td>
                                        <td className="px-4 py-4 text-[#6F6C90]">{plan.speed || "-"}</td>
                                        <td className="px-4 py-4 text-[#6F6C90] font-medium">{plan.custom_name || "-"}</td>
                                        <td className="px-4 py-4">
                                            {plan.type === 'nbn' ? (
                                                plan.isPublish ? (
                                        ...
                                        <td className="px-4 py-4 text-[#6F6C90] text-[12px]">
                                            {plan.features ? (Array.isArray(plan.features) ? plan.features.join(', ') : plan.features) : "-"}
                                        </td>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-[550px] max-h-[90vh] flex flex-col bg-white rounded-[20px] shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="flex items-center justify-between px-8 py-6 border-b border-[#DFDBE3] bg-white sticky top-0 z-10">
                            <h3 className="text-[20px] font-bold text-[#010C15]">Edit Configuration</h3>
                            <button
                                onClick={() => setEditPlan(null)}
                        ...
                        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
                            <form onSubmit={handleUpdate} className="space-y-6">
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Base Plan Name (Internal)</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className={`grid gap-4 ${editPlan.type === 'nbn' ? 'grid-cols-2' : 'grid-cols-1'}`}>
                                        <div>
                                            <label className="block text-[14px] font-semibold text-[#010C15] mb-2">{editPlan.type === 'nbn' ? 'Bandwidth ID' : 'Wholesale ID'}</label>
                                            <input
                                                type="text"
                                                defaultValue={editPlan.bandwidth_id || editPlan.value || "-"}
                                                disabled
                                                className="w-full rounded-[10px] border border-[#DFDBE3] bg-[#F8F9FA] px-[18px] py-[13px] text-[15px] text-[#6F6C90]"
                                            />
                                        </div>
                                        {editPlan.type === 'nbn' && (
                                            <div>
                                                <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Speed Profile</label>
                                                <input
                                                    type="text"
                                                    name="speed"
                                    ...
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">
                                            {editPlan.type === 'nbn' ? 'Default Website Name' : 'Custom Front-End Name'}
                                        </label>
                                        <input
                                            type="text"
                                            name="custom_name"
                                            defaultValue={editPlan.custom_name || ""}
                                            placeholder={editPlan.type === 'nbn' ? "e.g. Home Fast 100" : "Enter custom name"}
                                            className="w-full rounded-[10px] border border-[#DFDBE3] px-[18px] py-[13px] text-[15px] outline-none focus:border-[#401B60]"
                                        />
                                        {editPlan.type !== 'nbn' && <p className="text-[12px] text-[#6F6C90] mt-1 text-right">Leave blank to use Original Name</p>}
                                    </div>
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">
                                            {editPlan.type === 'nbn' ? 'Default Retail Price ($)' : 'Retail Price ($)'}
                                        </label>
                                        <input
                                            type="number"
                                            name="price"
                                    ...
                                    {editPlan.type === 'nbn' && (
                                        <div>
                                            <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Key Benefits (Optional Default)</label>
                                            <textarea
                                                name="features"
                                                defaultValue={Array.isArray(editPlan.features) ? editPlan.features.join('\n') : ""}
                                    ...
                                    {editPlan.type === 'nbn' && (
                                        <div className="space-y-3 pt-2">
                                            <label className="block text-[14px] font-semibold text-[#010C15]">Publishing Status</label>
                                            <div className="flex gap-6">
                                                <label className="flex items-center gap-2 cursor-pointer group">
                                                    ...
                                                    />
                                                    <span className="text-[14px] text-[#0A0A0A] group-hover:text-[#401B60]">CMS Only</span>
                                                </label>
                                                <label className="flex items-center gap-2 cursor-pointer group">
                                                    <input
                                                        type="radio"
                                                        ...
                                                        className="w-4 h-4 accent-[#401B60]"
                                                    />
                                                    <span className="text-[14px] text-[#0A0A0A] group-hover:text-[#401B60]">Publish to Website</span>
                                                </label>
                                            </div>
                                        </div>
                                    )}
            ...
            {isCreateModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-[550px] max-h-[90vh] flex flex-col bg-white rounded-[20px] shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
                        {/* Modal Header */}
                        <div className="flex items-center justify-between px-8 py-6 border-b border-[#DFDBE3] bg-white sticky top-0 z-10">
                            <h3 className="text-[20px] font-bold text-[#010C15]">Add Manual NBN Plan</h3>
                            <button
                                onClick={() => setIsCreateModalOpen(false)}
                                className="text-[#6F6C90] hover:text-[#401B60] transition-colors"
                            >
                            ...
                            <form onSubmit={handleCreate} className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Bandwidth ID</label>
                                            <input
                                                type="text"
                                                name="bandwidth_id"
                                                required
                                    ...
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Default Website Name</label>
                                        <input
                                            type="text"
                                            name="custom_name"
                                    ...
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Default Retail Price ($)</label>
                                        <input
                                            type="number"
                                            name="price"
                                            step="0.01"
                                    ...
                                    <div>
                                        <label className="block text-[14px] font-semibold text-[#010C15] mb-2">Default Key Benefits</label>
                                        <textarea
                                            name="features"
                                            placeholder="e.g. Unlimited Data, No Lock-in"
                                            className="w-full rounded-[10px] border border-[#DFDBE3] px-[18px] py-[13px] text-[15px] outline-none focus:border-[#401B60]"
