...
const IconEyeOff = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path
      d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-7-11-7a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 7 11 7a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"
      stroke="#6F6C90"
      strokeWidth="1.6"
    />
          ...
          <table className="w-full border-collapse text-left">
            ...
            <tbody className="text-[14px] text-[#0A0A0A]">
              {rows.map((r) => (
                ...
                >
                  <td>{r.id}</td>
                  <td className="text-[#401B60] underline-offset-2 hover:underline">
                    {r.name}
                  </td>
                  ...
                  <td className="font-semibold text-[#000]">
                    <span
                      className={
                        r.type === "NBN" ? "text-[#FF00A8]" : "text-[#000]"
                      }
                    >
                      {r.type}
                    </span>
              ...
              {rows.length === 0 && (
                <tr>
                  <td
                    colSpan={onEdit || onToggleActive || onDelete ? 9 : 8}
