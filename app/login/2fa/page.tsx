  ...
  return (
    <AuthShell>
      ...
      <div className="mt-6 text-center">
        <h1 className="text-[28px] font-extrabold leading-[34px] text-[#0A0A0A]">Two-Factor Authentication</h1>
        <p className="mt-2 text-[15px] text-[#6F6C90]">Choose how you'd like to receive your verification code</p>
      </div>
      ...
      <div className="mt-8 space-y-4">
        ...
        >
          ...
          <div>
            <div className="text-[15px] font-semibold text-[#0A0A0A]">Email Verification</div>
            <div className="text-[14px] text-[#6F6C90]">Send code to de***@example.com</div>
          </div>
        </button>
        ...
        >
          <span className="grid h-[44px] w-[44px] place-items-center rounded-full bg-[#3F205F]">
            ...
            <svg width="20" height="24" viewBox="0 0 20 24" fill="none" aria-hidden>
              <rect x="4" y="2" width="12" height="20" rx="3" stroke="white" strokeWidth="1.8" />
              <circle cx="10" cy="18" r="1.5" fill="white" />
            </svg>
          </span>
          <div>
            <div className="text-[15px] font-semibold text-[#0A0A0A]">SMS Verification</div>
            <div className="text-[14px] text-[#6F6C90]">Send code to +1 (***) ***-5678</div>
          </div>
        </button>
      </div>
