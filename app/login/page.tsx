  ...
  return (
    <AuthShell>
      ...
      <div className="mt-6 text-center">
        <h1 className="text-[32px] font-bold leading-[38px] text-[#0A0A0A]">
          Welcome Back
        </h1>
        <p className="mt-1 text-[16px] leading-[24px] text-[#6F6C90]">
      ...
      <form onSubmit={submit} className="mt-8 space-y-5">
        <div>
          <label className="mb-2 flex items-center gap-2 text-[14px] font-medium text-[#0A0A0A]">
            ...
            >
              <path
                d="M2 7.5 12 13l10-5.5M2 7.5v9c0 2 1.5 3 3 3h14c1.5 0 3-1 3-3v-9"
                stroke="#6F6C90"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
        ...
        <div className="flex items-center justify-between pt-1">
          <label className="inline-flex items-center gap-2 cursor-pointer group">
            ...
            <span className="text-[14px] text-[#0A0A0A] group-hover:text-[#3F205F] transition-colors">
              Remember me
            </span>
          </label>
          <button
          ...
          {signupDropdownOpen && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-white rounded-[12px] shadow-xl border border-[#E5E2EA] py-2 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
              <div className="px-2 py-1.5">
                <p className="text-[12px] font-medium text-[#6F6C90] px-2 mb-1">
                  Choose a service:
                </p>
              </div>
              {/* MBB internet */}
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold text-[#0A0A0A] group-hover:text-[#3F205F] transition-colors">
                    MBB internet
                  </div>
