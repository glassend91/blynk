...
export default function StaticIPInfoModal({
  onClose,
}: {
  onClose: () => void;
}) {
  return (
    <ModalShell onClose={onClose} size="narrow" showClose={true}>
      <div className="relative">
        <h3 className="text-[30px] font-extrabold text-[var(--cl-brand-ink)] pr-12">
        ...
        <ul className="mt-5 space-y-5">
          {[
            ...
            <li key={t} className="flex items-start gap-3">
              ...
              <div>
                <div className="text-[18px] font-semibold text-[#1A1531]">
                  {t}
                </div>
