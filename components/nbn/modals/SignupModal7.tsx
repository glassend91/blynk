    ...
    <ModalShell onClose={onClose} size="wide">
      ...
      <SectionPanel>
          ...
          <div className="mx-auto grid h-12 w-12 place-items-center rounded-full bg-[var(--cl-brand-ink)] text-white">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path
                ...
                strokeWidth="1.5"
              />
              <path d="M14 3v5h5" stroke="white" strokeWidth="1.5" />
            </svg>
          </div>
        ...
        <div className="card mx-auto mt-8 max-w-[640px] p-6">
          <div className="text-[15px] font-semibold text-[#2E2745]">
            Order Summary
          </div>
          <div className="mt-4 flex items-center justify-between border-b border-[#E9E3F2] pb-3 text-[15px]">
            ...
            <div className="font-semibold text-[#2E2745]">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24">
                <path
                  d="M9.57 5.93 3.5 12l6.07 6.07M20.5 12H4"
                  stroke="#6E6690"
                  strokeWidth="1.5"
                  strokeLinecap="round"
            ...
            <button
              ...
              onClick={onComplete}
              disabled={loading}
              className="btn-primary inline-flex items-center justify-center gap-3 disabled:opacity-60"
            >
              {loading ? "Submitting..." : "Complete Order"}
              <svg width="20" height="20" viewBox="0 0 24 24">
                <path
                  d="M14.43 5.93 20.5 12l-6.07 6.07M3.5 12H20.33"
                  stroke="white"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
