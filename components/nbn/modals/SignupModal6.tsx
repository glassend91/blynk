...
export default function SignupModal6({
  ...
  // Example amount - you should get this from your plan selection
  const paymentAmount = 69.00; // $69/month for NBN plan

  const handlePaymentSuccess = (paymentIntent: any) => {
    console.log('Payment succeeded:', paymentIntent);
    setPaymentSuccess(true);
    setPaymentError(null);
    // You can call onNext() here or handle the success differently
    setTimeout(() => {
      onNext();
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-semibold text-gray-700">Monthly Plan</span>
                    <span className="text-lg font-bold text-gray-900">${paymentAmount.toFixed(2)} AUD</span>
                  </div>
                  <div className="text-sm text-gray-500">
                    First month payment - no setup fees
                  </div>
                </div>
