          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[18px] leading-[30px] text-[#6F6C90]">
                Local experts making internet and mobile simple for Australian
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <path
                    d="M31.3396 15.6309H34.7864L27.2562 24.2374L36.1149 35.949H29.1786L23.7458 28.846L17.5295 35.949H14.0806L22.1349 26.7433L13.6367 15.6309H20.7491L25.6599 22.1233L31.3396 15.6309ZM30.1299 33.886H32.0398L19.7113 17.5856H17.6618L30.1299 33.886Z"
                    fill="#401B60"
                  />
                </svg>
                <svg
            ...
            {/* Contact */}
            <div>
              <h4 className="text-[#170F49] text-[20px] font-bold">
                Contact us
              </h4>
              <ul className="mt-6 space-y-4 text-[18px] text-[#6F6C90]">
                <li className="flex items-center gap-2">
                  ...
                  >
                    <path
                      d="M18.3087 15.4501C18.3087 15.7501 18.242 16.0585 18.1003 16.3585C17.9587 16.6585 17.7753 16.9418 17.5337 17.2085C17.1253 17.6585 16.6753 17.9835 16.167 18.1918C15.667 18.4001 15.1253 18.5085 14.542 18.5085C13.692 18.5085 12.7837 18.3085 11.8253 17.9001C10.867 17.4918 9.90866 16.9418 8.95866 16.2501C8.00033 15.5501 7.09199 14.7751 6.22533 13.9168C5.36699 13.0501 4.59199 12.1418 3.90033 11.1918C3.21699 10.2418 2.66699 9.2918 2.26699 8.35013C1.86699 7.40013 1.66699 6.4918 1.66699 6.4918"
                      stroke="#6F6C90"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    />
                ...
                <li className="flex items-center gap-2">
                  ...
                  >
                    <path
                      d="M7.0837 16.0086H6.66699C3.33366 16.0086 1.66699 15.1753 1.66699 11.0086V6.84192C1.66699 3.50859 3.33366 1.84192 6.66699 1.84192H13.3337C16.667 1.84192 18.3337 3.50859 18.3337 6.84192V11.0086C18.3337 14.3419 16.667 16.0086 13.3337 16.0086H12.917C12.6587 16.0086 12.4087 16.1336 12.2503 16.3419L11.0003 18.0086C10.4503 18.7419 9.55033 18.7419 9.00033 18.0086L7.75033 16.3419C7.61699 16.1586 7.30866 16.0086 7.0837 16.0086Z"
                      stroke="#6F6C90"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    />
