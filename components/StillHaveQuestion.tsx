          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 25" fill="none">
                <path
                  d="M12 14.244C13.723 14.244 15.12 12.847 15.12 11.124C15.12 9.401 13.723 8.004 12 8.004C10.277 8.004 8.88 9.401 8.88 11.124C8.88 12.847 10.277 14.244 12 14.244Z"
                  stroke="#401B60"
                  strokeWidth="1.5"
                />
                <path
                  d="M3.62 9.304C5.59 0.644 18.42 0.654 20.38 9.314C21.53 14.395 18.37 18.695 15.6 21.355C13.59 23.295 10.41 23.295 8.39 21.355C5.63 18.695 2.47 14.385 3.62 9.304Z"
                  stroke="#401B60"
                  strokeWidth="1.5"
                />
              </svg>
