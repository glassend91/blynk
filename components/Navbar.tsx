...
export default function Navbar() {
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      if (
        internetDropdownRef.current &&
        !internetDropdownRef.current.contains(event.target as Node)
      ) {
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-10">
            ...
            <nav className="hidden md:flex items-center gap-9">
              ...
              <Link href="/about" className="text-[18px] font-bold text-black">
                About
              </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M3.01675 7.0763C4.65842 -0.140363 15.3501 -0.132029 16.9834 7.08464C17.9417 11.318 15.3084 14.9013 13.0001 17.118C11.3251 18.7346 8.67508 18.7346 6.99175 17.118C4.69175 14.9013 2.05842 11.3096 3.01675 7.0763Z"
                  stroke="#401B60"
                  strokeWidth="1.5"
                />
              </svg>
            ...
            >
              ...
              >
                <path
                  d="M18.1404 21.6207C17.2604 21.8807 16.2204 22.0007 15.0004 22.0007H9.00035C7.78035 22.0007 6.74035 21.8807 5.86035 21.6207C6.08035 19.0207 8.75035 16.9707 12.0004 16.9707C15.2504 16.9707 17.9204 19.0207 18.1404 21.6207Z"
                  stroke="white"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
