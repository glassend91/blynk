...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="md:hidden border-t border-black/5 bg-white">
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button className="flex-1 rounded-lg border border-[#401B60] px-4 py-2 text-[#401B60] font-bold">Find Local Support</button>
                <button className="flex-1 rounded-lg bg-[#401B60] px-4 py-2 text-white font-semibold">Login</button>
              </div>
            </div>
          </div>
        )}
      ...
      {/* Mobile Broadband Signup Flow Controller */}
