...
export default function BsmStepper({ active, onStepClick, maxReached }: { active: number; onStepClick?: (step: number) => void; maxReached?: number }) {
        ...
        {LABELS.map((label, i) => {
          ...
          return (
            ...
            >
              ...
              <div className={["text-center text-[11px] leading-tight font-medium transition-all", isActive ? "text-[#170F49]" : "text-[#8A84A3]", isClickable ? "group-hover:text-[#170F49]" : ""].join(" ")}>
