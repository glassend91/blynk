...
}: { onBack: () => void; onComplete: () => void; loading?: boolean; error?: string; }) {
  ...
  return (
    <SectionPanel>
      <div className="text-center">
        ...
        <h2 className="mt-4 text-[28px] font-extrabold leading-[34px] text-[#170F49]">Complete Business Order</h2>
        <p className="mt-1 text-[14px] leading-[22px] text-[#6F6C90]">Review your business plan details and finalize your order</p>
      </div>
