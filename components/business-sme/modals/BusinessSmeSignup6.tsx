        ...
        {paymentSuccess ? (
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-[16px] border border-[#E7E4EC] bg-[#FBF8FF] p-6 shadow-[0_24px_60px_rgba(64,27,118,0.08)]">
              <div className="text-[18px] font-semibold text-[#2B1940] mb-4">Order Summary</div>
              <div className="space-y-3 text-[14px]">
                <div className="flex items-center justify-between">
                  <span className="text-[#5B5668]">Selected Plan:</span>
                  <span className="font-semibold text-[#2B1940]">Business Standard NBN</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#5B5668]">Monthly Cost:</span>
                  <span className="font-semibold text-[#2B1940]">${paymentAmount.toFixed(2)}/month</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="pt-3 border-t border-[#E7E4EC]">
                  <div className="flex items-center justify-between">
                    <span className="text-[16px] font-semibold text-[#2B1940]">Total:</span>
