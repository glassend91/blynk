...
export default function BusinessSmeSignup2({
  ...
  const plans = [
    { id:"basic",    name:"Business Basic NBN",    price:"$89",  bullets:[
      "25/10 Mbps guaranteed speeds", "Unlimited data", "24/7 Business Support", "SLA Guarantee", "Priority Network Access"]},
    { id:"standard", name:"Business Standard NBN", price:"$129", badge:"Most Popular", bullets:[
      "25/20 Mbps guaranteed speeds", "Unlimited data", "24/7 Business Support", "SLA Guarantee", "Priority Network Access", "Enhanced Security"]},
    { id:"premium",  name:"Business Premium NBN",  price:"$189", bullets:[
      "Unlimited data", "24/7 Business Support", "SLA Guarantee", "Priority Network Access", "Enhanced Security", "Dedicated Account Manager"]},
  ];
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="text-[18px] font-semibold text-[#2B1940]">{p.name}</div>
                {p.badge && (
              ...
              <div className="mt-2 text-[32px] font-extrabold text-[#4F1C76]">
                {p.price}
                <span className="ml-1 text-[16px] font-semibold text-[#2B1940]">/month</span>
              </div>
