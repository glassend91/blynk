        ...
        <div className="flex items-center gap-3">
          <span className="grid h-12 w-12 place-items-center rounded-full bg-[#2F2151] text-white">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
              <path d="M5.5 18.4V15.6c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v2.8c0 2-1.6 3.6-3.6 3.6S2 20.4 2 18.4v-6.3C1.9 6.6 6.3 2 12 2s10.1 4.6 10.1 10.1v6.3c0 2-1.6 3.6-3.6 3.6s-3.6-1.6-3.6-3.6v-3.1c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8v3.1" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
        ...
        <div className="flex w-full items-center gap-3 sm:w-auto">
          ...
          >
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
              <path d="M7.4 6.3 15.9 3.5c3.8-1.3 5.9.8 4.6 4.6l-2.8 8.5c-1.9 5.7-5 5.7-6.9 0l-.8-2.5-2.5-.8C1.7 11.3 1.7 8.2 7.4 6.3Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="m10.1 13.6 3.6-3.6" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Contact Us
          </button>
          <a
