    ...
    <ModalShell onClose={onClose} size="wide">
      ...
      <SectionPanel>
        ...
        <div className="mx-auto mt-8 max-w-[720px] space-y-4">
          ...
          >
            <div>
              <div className="text-[16px] font-semibold text-[#2E2745]">Keep my existing number</div>
              <div className="mt-1 text-[13px] text-[#6F6C90]">Port your current mobile number to Blynk</div>
            </div>
            <div className={[
              "grid h-5 w-5 place-items-center rounded-full border-2",
              numberChoice === "keep" ? "border-[#5C3B86] bg-[#5C3B86]" : "border-[#CFC8DA]",
            ].join(" ")}>
              {numberChoice === "keep" && (
          ...
          >
            <div>
              <div className="text-[16px] font-semibold text-[#2E2745]">Get a new number</div>
              <div className="mt-1 text-[13px] text-[#6F6C90]">Choose from our available mobile numbers</div>
            </div>
            <div className={[
              "grid h-5 w-5 place-items-center rounded-full border-2",
              numberChoice === "new" ? "border-[#5C3B86] bg-[#5C3B86]" : "border-[#CFC8DA]",
            ].join(" ")}>
              {numberChoice === "new" && (
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                  <path d="M20 6L9 17l-5-5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <BarActions onBack={onBack} onNext={onNext} nextDisabled={!numberChoice} />
    </ModalShell>
  );
}
