...
export default function MobileVoiceSignup7({
  ...
  const planPrice = selectedPlan?.price || 35.0;
    ...
    <ModalShell onClose={onClose} size="wide">
      ...
      <SectionPanel>
        <div className="text-center">
          {error ? (
            <>
              ...
              <h2 className="mt-4 text-[28px] font-extrabold leading-[34px] text-red-700">
                Order Issue
              </h2>
              <p className="mt-1 text-[14px] leading-[22px] text-red-600 font-medium">
                We encountered a problem with your order submission.
              </p>
              <p className="mt-4 text-[15px] text-[#6A6486] max-w-md mx-auto">
                Your payment was processed, but the order could not be completed
                at this time. Our team has been notified.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="mt-4 text-[15px] text-[#6A6486] max-w-md mx-auto">
                You will receive an email shortly with your new plan details and
                receipt.
              </p>
            </>
          )}
        ...
        <div className="mx-auto mt-8 max-w-[560px] rounded-[12px] border border-[#EEE8F6] bg-white p-5 shadow-[0_40px_60px_rgba(0,0,0,0.06)]">
          <div className="text-[15px] font-semibold text-[#2E2745] mb-4">
            Order Summary
          </div>
          ...
          <div className="mt-4 space-y-2 text-[14px]">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[#2E2745] font-medium">
