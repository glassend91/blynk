...
const Icons: any = {
  user: (
    <svg width="24" height="24" viewBox="0 0 36 37" fill="none" aria-hidden>
      <path
        d="M13.74 16.805c-.15-.015-.33-.015-.495 0C9.675 16.685 6.84 13.76 6.84 10.16 6.84 6.485 9.81 3.5 13.5 3.5c3.675 0 6.66 2.985 6.66 6.66-.015 3.6-2.85 6.525-6.42 6.645Z"
        stroke="#401B60"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M24.617 6.5c2.91 0 5.25 2.355 5.25 5.25 0 2.835-2.25 5.145-5.055 5.25-.12-.015-.255-.015-.39 0"
        stroke="#401B60"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6.238 22.34c-3.63 2.43-3.63 6.39 0 8.805 4.125 2.76 10.89 2.76 15.015 0 3.63-2.43 3.63-6.39 0-8.805-4.11-2.745-10.875-2.745-15.015 0Z"
        stroke="#401B60"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  headset: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M4 9a8 8 0 0 1 16 0v6a4 4 0 0 1-4 4h-2"
        stroke="#6F6C90"
        strokeWidth="1.6"
      />
      <rect
...
export default function KpiCard({ title, value, delta, trend, icon }: any) {
