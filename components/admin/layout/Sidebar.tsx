      ...
      <div className="flex h-[calc(100%-153px)] flex-col gap-6 overflow-auto px-[1px] py-[18px]">
        ...
        <Section title="Management">
          <Item
            ...
            show={
              mounted ? (routeAccess["/admin/user-management"] ?? true) : true
            }
          />
          <Item
            label="Staff Members"
            ...
            show={
              mounted ? (routeAccess["/admin/staff-members"] ?? true) : true
            }
          />
          <Item
            ...
            show={
              mounted ? (routeAccess["/admin/role-management"] ?? true) : true
            }
          />
        </Section>
        ...
        <Section title="Content">
          <Item
            ...
            show={
              mounted ? (routeAccess["/admin/service-plans"] ?? true) : true
            }
          />
          <Item
            label="Wholesaler Plans"
            href="/admin/wholesaler-plans"
            show={
              mounted ? (routeAccess["/admin/wholesaler-plans"] ?? true) : true
            }
          />
          <Item
            ...
            show={
              mounted ? (routeAccess["/admin/website-content"] ?? true) : true
            }
          />
          <Item
            label="Testimonial"
            href="/admin/testimonials"
            show={mounted ? (routeAccess["/admin/testimonials"] ?? true) : true}
          />
        </Section>
        ...
        <Section title="Operations">
          <Item
            ...
            href="/admin/technician-network"
            show={
              mounted
                ? (routeAccess["/admin/technician-network"] ?? true)
                : true
            }
          />
          <Item
            label="SIM Orders"
            href="/admin/sim-orders"
            show={mounted ? (routeAccess["/admin/sim-orders"] ?? true) : true}
          />
          <Item
            label="Support Tickets"
            href="/admin/support-tickets"
            show={
              mounted ? (routeAccess["/admin/support-tickets"] ?? true) : true
            }
          />
          <Item
            ...
            show={
              mounted
                ? (routeAccess["/admin/customer-dashboard"] ?? true)
                : true
            }
          />
        </Section>
        ...
        <Section title="System">
          <Item
            ...
            show={
              mounted ? (routeAccess["/admin/system-settings"] ?? true) : true
            }
          />
        </Section>
      </div>
