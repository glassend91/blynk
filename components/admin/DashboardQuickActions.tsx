...
const I: any = {
  ...
  sim:   (<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="7" y="3" width="10" height="18" rx="2" stroke="#401B60" strokeWidth="1.8"/><rect x="9" y="9" width="6" height="7" rx="1.2" stroke="#401B60" strokeWidth="1.6"/></svg>),
};
    ...
    <div className="rounded-[12.75px] border border-[#DFDBE3] bg-white p-5">
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        {actions.map((a:any) => (
          ...
          >
            <span className="text-[14px] font-semibold text-[#0A0A0A]">{a.label}</span>
